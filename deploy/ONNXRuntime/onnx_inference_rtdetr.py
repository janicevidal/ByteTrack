...
class Predictor(object):
    ...
    def inference(self, ori_img, timer):
        ...
        return boxes, labels, scores, img_info
    ...
    while True:
        ...
        if ret_val: 
            ...
            for img in batch_image_list:
                ...
                boxes, labels, scores, _ = predictor.inference(frame, timer)
                ...
                for i, (box, score, label) in enumerate(zip(boxes, scores, labels)):
                    ...
                    # if i == 0:
                    #     boxes_array = box_array
                    # else:
                    #     boxes_array = np.vstack((boxes_array, box_array))
